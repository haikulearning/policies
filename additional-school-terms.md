...
## 1. KEEPING YOUR STUDENT DATA CONFIDENTIAL (THIS IS VERY IMPORTANT TO US) AND COMPLYING WITH APPLICABLE LAWS <a name="student-data-confidentiality"></a>
[keeping-data-confidential]: #student-data-confidentiality
...
## 2. AUTHORIZATION TO ACCESS YOUR STUDENT DATA <a name="authorization-to-access-your-student-data"></a>
[auth-to-access-student-data]: #authorization-to-access-your-student-data

### 2.1 Our Access <a name="our-access-to-student-data"></a>
[our-access-to-student-data]: #our-access-to-student-data
...
### 2.3 Other Access <a name="other-access-to-student-data"></a>
[other-access-to-student-data]: #other-access-to-student-data
...
## 3. HOW WE USE YOUR STUDENT DATA <a name="use-of-student-data"></a>
[use-of-student-data]: #use-of-student-data

### 3.1 In General <a name="general-use-of-student-data"></a>
[general-use-of-student-data]: #general-use-of-student-data
...
### 3.2 Anonymized Data <a name="use-of-ananymized-student-data"></a>
[anonymized-data-use]: #use-of-ananymized-student-data
...
## 4. DELETING STUDENT DATA AND TERMINATING YOUR ACCESS TO THE SERVICES  <a name="deleting-student-data-and-terminating-your-service"></a>
[deletion-and-termination]: #deleting-student-data-and-terminating-your-service

### 4.1 Deleting Student Data  <a name="deleting-student-data"></a>
[deleting-student-data]: #deleting-student-data

You may request in writing that we delete any of your Student Data (except as provided for in [Section 3.2][anonymized-data-use] above) in our possession at any time. We will comply with your request in a commercially reasonable time, not to exceed thirty (30) business days. If you grant access to Student Data to a Developer and subsequently need that data deleted, you need to request such deletion directly from that Developer.

### 4.2 Terminating Your Access To These Services  <a name="terminating-your-access"></a>
[terminating-access]: #terminating-your-access
...
## 5. PRIVACY AND SECURITY  <a name="privacy-and-security"></a>
...
## 6. OTHER TERMS SPECIFIC TO SCHOOLS <a name="other-terms-for-schools"></a>
[other-terms-for-schools]: #other-terms-for-schools
...
## 7. QUESTIONS <a name="contact-us"></a>
